...
<body>
  ...
  <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Lançamento de Presença</a>
    ...
    <?php include('menu.php'); ?>
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div
          ...
          <h1 class="h2">Consulta de Colaboradores</h1>
        </div>
                ...
                <div class="row mb-12">
                  ...
                  <div class="col-sm-2">
                    <ol class="breadcrumb float-sm-right">
                      <li class="breadcrumb-item"><a href="./start/index.php">Home</a></li>
                    </ol>
                  </div>
                </div>
              </div>
